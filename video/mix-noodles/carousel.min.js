...
(function (factory) {factory(jQuery); })(function($){
	$.fn.jR3DCarousel = function(options){
		...
		(function setup(){
			...
			if(_settings.autoplay){ _playjR3DCarousel();}
			...
			function _createControls(){
				if(_settings.rotationDirection == 'ltr'){
					_previousButton = $( "<div class='previous controls' style='left: -3px;'><img src='//ms.purplepatch.online/video-image/gp/recharge-test/arrow_l.png'</div>");
					_nextButton = $( "<div class='next controls' style='right: right: -3px;'><img src='//ms.purplepatch.online/video-image/gp/recharge-test/arrow.png'</div>");
				}else{
					_previousButton = $( "<div class='previous controls' style='left:-3px;'><img src='//ms.purplepatch.online/video-image/gp/recharge-test/arrow_l" +
							".png'</div>");
					_nextButton = $( "<div class='next controls' style='right:-3px;'><img src='//ms.purplepatch.online/video-image/gp/recharge-test/arrow.png'</div>");
				}
				...
				_previousButton.add(_nextButton)
							   ...
							   .appendTo(_container)
							    $( ".previous" ).css({ "opacity": "0.75", "zIndex": "3" ,  transform: 'translateZ(1px)' } );
								$( ".next" ).css({ "opacity": "0.75", "zIndex": "3",  transform: 'translateZ(1px)' } );
		...
		function _playIfSlideVideo(){
			...
			if(_videoSlide){
				...
				video.pause();
				_timeOutTimer= setTimeout(_playNextSlide, 2e3);
			}
		}
